        ...
        <div class="x_panel">
          <div class="x_title">
            <h2>Genel Ayarlar <small>
              ...
              <b style="color: green">İşlem Başrılı</b>
            ...
            <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" value="<?php echo $ayarcek['ayar_tittle'] ?>" name="ayar_tittle" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
